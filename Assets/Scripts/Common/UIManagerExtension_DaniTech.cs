...
{
    public static string GetUIPath(this DaniTechUIManager uiManager, DaniTechUIType uiType)
    {
        string path = string.Empty; // "" == string.Empty
        switch (uiType)
        {
            case DaniTechUIType.SimplePopup:
            ...
            case DaniTechUIType.MyProfilePopup: 
                path = "Prefabs/UI/MyProfilePopup";
                break;
            case DaniTechUIType.DaniTechInventory:
                path = "Prefabs/UI/SampleUI_InventoryStyle";
                break;
            case DaniTechUIType.QuestUI:
                path = "Prefabs/UI/SUI_QuestUI";
                break;
    ...
    {
        DaniTechUIType openUiType = DaniTechUIType.SimplePopup;
        ...
        if (gObj != null)
        {
            ...
            var simplePopup = gObj.GetComponent<DaniTech_SimplePopup>();
            if (simplePopup == null)
            {
                return;
            }
    ...
    public static void OpenMyProfilePopup(this DaniTechUIManager uiManager, string characterDataId)
    {
        ...
        DaniTechUIType openUiType = DaniTechUIType.MyProfilePopup;
        var gObj = uiManager.GetCreatedUI(openUiType);
        ...
        if (gObj != null)
        {
            ...
            var simplePopup = gObj.GetComponent<DaniTech_MyProfilePopup>();
            if (simplePopup == null)
            {
                return;
            }
    ...
    {
        DaniTechUIType openUiType = DaniTechUIType.DaniTechInventory;
    ...
    public static void OpenQuestUI(this DaniTechUIManager uiManger)
    {
        DaniTechUIType openUiType = DaniTechUIType.QuestUI;
        var gObj = uiManger.GetCreatedUI(openUiType);
        ...
        if (gObj != null)
        {
            ...
            //var simplePopup = gObj.GetComponent<QuestUI>();
            //if (simplePopup == null)
            //{
            //    return;
            //}
