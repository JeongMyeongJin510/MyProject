...
public class DaniTechUIManager : MonoBehaviour
{
    ...
    private Dictionary<DaniTechUIType, GameObject> _createdUIDic = new Dictionary<DaniTechUIType, GameObject>();
    ...
    public void OpenUI(DaniTechUIType uiType, GameObject uiObject)
    {
    ...
    private void CreateUI(DaniTechUIType uiType)
    {
    ...
    public GameObject GetCreatedUI(DaniTechUIType uiType)
    {
        if (_createdUIDic.ContainsKey(uiType) == false)
        {
            CreateUI(uiType);
    ...
    public void CloseSpecificUI(DaniTechUIType uiType)
    {
        CloseUI(uiType);
    }
